...
criteria="This script lists all app-tier EBS volumes based on a specific tag and checks if they are encrypted.
...
# Set the tag key and value for identifying app-tier volumes
...
# Audit only regions with app-tier volumes
...
echo "Audit completed for all regions with app-tier EBS volumes."
