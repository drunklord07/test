...
description="AWS Audit: S3 Bucket ACL for Authenticated Users"
criteria="This script checks if any S3 bucket grants FULL_CONTROL to the 'Authenticated Users' group."
