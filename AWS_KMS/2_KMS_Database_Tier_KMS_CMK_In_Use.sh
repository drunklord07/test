...
description="AWS Audit for Database Tier KMS Customer Master Key (CMK) Tag Compliance"
criteria="This script checks if each AWS KMS CMK used in the database tier has tags assigned."
